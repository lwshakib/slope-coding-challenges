          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mt-0 lg:mr-auto">
                ...
                <h1 className="fade-in-blur mx-auto mt-8 max-w-4xl animate-in text-5xl font-black tracking-tight text-balance italic duration-1000 slide-in-from-bottom-4 md:text-7xl lg:mt-16 xl:text-[5.25rem]">
                  Master the Art of{" "}
                  <span className="text-primary not-italic underline decoration-primary/30 underline-offset-8">
                    Competitive
                  </span>{" "}
                  Coding
                </h1>
                <TextEffect
                  ...
                  delay={0.5}
                  as="p"
                  className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed font-medium text-balance text-muted-foreground"
                >
                  The premium platform for technical interview preparation.
                  Solve 3,000+ challenges, compete in global contests, and land
                  your dream role.
                </TextEffect>
                ...
                >
                  <div
                    key={1}
                    className="rounded-[calc(var(--radius-xl)+0.125rem)] border border-primary/30 bg-primary/20 p-0.5 shadow-[0_0_20px_rgba(var(--primary-rgb),0.1)]"
                  >
                    <Button
                      asChild
                      size="lg"
                      className="rounded-xl px-12 text-base font-black tracking-widest uppercase italic shadow-xl shadow-primary/20"
                    >
                  ...
                  <Button
                    ...
                    size="lg"
                    variant="ghost"
                    className="h-12 rounded-xl px-8 text-sm font-bold tracking-widest text-muted-foreground uppercase hover:text-foreground"
                  >
                    <Link href="/contests">

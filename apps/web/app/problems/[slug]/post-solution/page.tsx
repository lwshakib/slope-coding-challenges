...
import { 
    ...
    Heading1, Heading2, Terminal, Info, Globe, MessageSquare, ThumbsUp, Sun, Moon
} from 'lucide-react'
...
export default function PostSolutionPage() {
    ...
    return (
        <div className="h-screen bg-background text-foreground flex flex-col font-sans overflow-hidden">
            {/* Header */}
            <header className="h-16 border-b border-border/40 flex items-center justify-between px-6 bg-background/80 backdrop-blur-xl z-50">
                <div className="flex-1 max-w-2xl px-4">
                    <Input 
                        value={title}
                        onChange={(e) => setTitle(e.target.value)}
                        placeholder="Enter your title"
                        className="!bg-transparent !dark:bg-transparent border-none focus-visible:ring-0 focus-visible:ring-offset-0 outline-none shadow-none text-2xl font-black placeholder:text-muted-foreground/30 h-14"
                    />
                </div>
            ...
            {/* Toolbar */}
            <div className="h-12 border-b border-border/40 bg-background flex items-center px-6 gap-1">
            ...
            <main className="flex-1 flex overflow-hidden">
                {/* Editor Pane */}
                <div className="flex-1 border-r border-border/40 flex flex-col bg-muted/5">
                ...
                <div className="flex-1 bg-background overflow-hidden flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar">
                        <div className={cn("p-10 prose max-w-none prose-headings:font-black prose-p:leading-relaxed", theme === 'dark' ? "prose-invert" : "")}>
                            <ReactMarkdown
                                components={{
